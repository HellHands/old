...
<tr><td colspan="2"><h1>1.School Identification</h1></td></tr><input type="hidden" value="<?php echo $school['School']['id']?>" name="school_id" /> <input type="hidden" name="cluster_id" value="<?php echo $school['School']['clusterid']?>" />
...
<tr><td></td><td>No. of Households in village/vicinity (street): <br /><input type="text" value="" name="school_vicinity_households" /></td></tr>
...
<tr><td></td>
	<td>Distance from GS to NG <br />
		<input type="text" value="" name="gtng1" class="number" />:Dir<input type="text" value="" name="dir1" class="number" />
	</td>
</tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng2" class="number" />:Dir<input type="text" value="" name="dir2" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng3" class="number" />:Dir<input type="text" value="" name="dir3" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng4" class="number" />:Dir<input type="text" value="" name="dir4" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng5" class="number" />:Dir<input type="text" value="" name="dir5" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng6" class="number" />:Dir<input type="text" value="" name="dir6" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng7" class="number" />:Dir<input type="text" value="" name="dir7" class="number" /></td></tr>
<tr><td></td><td>Distance from GS to NG <br /><input type="text" value="" name="gtng8" class="number" />:Dir<input type="text" value="" name="dir8" class="number" /></td></tr>
...
<tr><td>2.8 School has recieved annual budget </td><td><input type="radio" name="budget_recieved" checked="checked" value="1" >Yes</input><br /><input type="radio" name="budget_recieved" value="0" >No</input></td></tr>
<tr><td>2.9 School has bank account</td><td><input type="radio" name="school_account" checked="checked" value="1" >Yes</input><br /><input type="radio" name="school_account" value="0" >No</input></td></tr>
...
<tr><td>2.11 School has middle/elementary school <br />within an approximate distance of 1.5 KM</td><td><input type="radio" name="school_in_range" checked="checked" value="1" >Yes</input><br /><input type="radio" name="school_in_range" value="0" >No</input></td></tr>
<tr><td>2.12 School has a high school/higher secondary <br />school available within an approximate distance of 1.5 KM</td><td><input type="radio" name="high_school_in_range" checked="checked" value="1" >Yes</input><br /><input type="radio" name="high_school_in_range" value="0" >No</input></td></tr>

<tr><td><strong>3. RECORDS</strong></td><td></td></tr>
<tr><td>3.1 Teacher Attendance Register</td>
	<td>
		<input type="radio" name="tar_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="tar_available" value="0" >Not available</input><br />
		<input type="radio" name="tar_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="tar_updated" value="0" >Not Updated</input></td></tr>
<tr><td>3.2 Teacher level record</td>
	<td>
		<input type="radio" name="tlr_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="tlr_available" value="0" >Not available</input><br />
		<input type="radio" name="tlr_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="tlr_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.3 Students attendance register</td>
	<td>
		<input type="radio" name="stu_att_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="stu_att_available" value="0" >Not available</input><br />
		<input type="radio" name="stu_att_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="stu_att_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.4 General Register</td>
	<td>
		<input type="radio" name="gr_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="gr_available" value="0" >Not available</input><br />
		<input type="radio" name="gr_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="gr_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.5 Examination Result</td>
	<td>
		<input type="radio" name="exam_result_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="exam_result_available" value="0" >Not available</input><br />
		<input type="radio" name="exam_result_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="exam_result_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.6 Visitor Book</td>
	<td>
		<input type="radio" name="vb_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="vb_available" value="0" >Not available</input><br />
		<input type="radio" name="vb_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="vb_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.7 SEMIS School form</td>
	<td>
		<input type="radio" name="ss_form_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="ss_form_available" value="0" >Not available</input><br />
		<input type="radio" name="ss_form_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="ss_form_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.8 Textbook distribution form</td>
	<td>
		<input type="radio" name="tb_distribution_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="tb_distribution_available" value="0" >Not available</input><br />
		<input type="radio" name="tb_distribution_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="tb_distribution_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.9 Girls Stipend Record</td>
	<td>
		<input type="radio" name="gs_record_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="gs_record_available" value="0" >Not available</input><br />
		<input type="radio" name="gs_record_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="gs_record_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.10 Asset/Stock Register</td>
	<td>
		<input type="radio" name="as_register_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="as_register_available" value="0" >Not available</input><br />
		<input type="radio" name="as_register_updated" checked="checked" value="1" >Updated</input><br />
		<input type="radio" name="as_register_updated" value="0" >Not Updated</input>
	</td>
</tr>
<tr><td>3.11 SMC Register</td>
	<td>
		<input type="radio" name="smc_register_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="smc_register_available" value="0" >Not available</input><br />
		<input type="radio" name="smc_register_updated" checked="checked" value="1" >Updated</input><br />
...
<tr><td> 3.12.1 SMC Notification </td>
	<td>
		<input type="radio" name="smc_notif_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="smc_notif_available" value="0" >Not available</input>
	</td>
</tr>
<tr><td> 3.12.2 SMC Guideline </td>
	<td>
		<input type="radio" name="smc_guideline_available" checked="checked" value="1" >Available</input><br />
...
<tr><td> 3.12.4 SMC Bank Account Information </td>
	<td>
		<input type="radio" name="smc_accountinfo_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="smc_accountinfo_available" value="0" >Not available</input>
	</td>
</tr>
<tr><td> 3.13 School Improvement Plan(SIP):</td>
	<td>
		<input type="radio" name="sip_available" checked="checked" value="1" >Available</input><br />
		<input type="radio" name="sip_available" value="0" >Not available</input><br />
		<input type="radio" name="sip_updated" checked="checked" value="1" >Updated</input><br />
...
<tr>
	...
	<input type="radio" name="toilets_available" checked="checked" value="1" >Yes</input><br />
...
<tr><td>5.1.3 The toilet clean with no smell </td><td><input type="radio" name="toilet_cleanliness" checked="checked" value="1" >Yes</input><br /><input type="radio" name="toilet_cleanliness" value="0" >No</input></td></tr>
<tr><td>5.1.4 A door for toilet that closes</td><td><input type="radio" name="toilet_closing_door" checked="checked" value="1" >Yes</input><br /><input type="radio" name="toilet_closing_door" value="0" >No</input></td></tr>
<tr><td>5.1.5 Water available in toilet for for flushing and hand washing</td><td><input type="radio" name="water_available_in_toilet" checked="checked" value="1" >Yes</input><br /><input type="radio" name="water_available_in_toilet" value="0" >No</input></td></tr>
<tr><td>5.1.6 Adequate drainage (disposal/septic tank)</td><td><input type="radio" name="toilet_drainage" checked="checked" value="1" >Yes</input><br /><input type="radio" name="toilet_drainage" value="0" >No</input></td></tr>

<tr><td>5.2 Water Provision</td></tr>
<tr><td>5.2.1 Water available inside school</td><td><input type="radio" name="water_available_in_school" checked="checked" value="1" >Yes</input><br /><input type="radio" name="water_available_in_school" value="0" >No</input></td></tr>
<tr><td>5.2.2 Source of water</td><td><input type="radio" name="water_source_type" checked="checked" value="1" >Hand Pump</input><br /><input type="radio" name="water_source_type" value="2" >Motor Operated</input><br /><input type="radio" name="water_source_type" value="3" >Hand Carry</input></td></tr>
<tr><td>5.2.3 Water is clean and drinkable</td><td><input type="radio" name="water_drinkable" checked="checked" value="1" >Yes</input><br /><input type="radio" name="water_drinkable" value="0" >No</input></td></tr>
<tr><td>5.2.4 Drinking water accesible to children</td><td><input type="radio" name="water_accessible_to_children" checked="checked" value="1" >Yes</input><br /><input type="radio" name="water_accessible_to_children" value="0" >No</input></td></tr>
<tr><td>5.2.5 Enough water for all purposes</td><td><input type="radio" name="water_for_all_purpose" checked="checked" value="1" >Yes</input><br /><input type="radio" name="water_for_all_purpose" value="0" >No</input></td></tr>

<tr><td>5.3 Electricity and Fixtures</td></tr>
<tr><td>5.3.1 The School has electricity</td><td><input type="radio" name="school_has_electricity" checked="checked" value="1" >Yes</input><br /><input type="radio" name="school_has_electricity" value="0" >No</input></td></tr>
<tr><td>5.3.2 Electricity wiring installed </td><td><input type="radio" name="electricity_wiring_installed" checked="checked" value="1" >Yes</input><br /><input type="radio" name="electricity_wiring_installed" value="0" >No</input></td></tr>
<tr><td>5.3.3 Electricity is on right now</td><td><input type="radio" name="electricity_on_right_now" checked="checked" value="1" >Yes</input><br /><input type="radio" name="electricity_on_right_now" value="0" >No</input></td></tr>
<tr><td>5.3.4 Formal Electricity meter installed</td><td><input type="radio" name="electricity_meter_installed" checked="checked" value="1" >Yes</input><br /><input type="radio" name="electricity_meter_installed" value="0" >No</input></td></tr>
...
<tr><td>5.4.1 Any broken window or window panes</td><td><input type="radio" name="broken_window_panes" checked="checked" value="1" >Yes</input><br /><input type="radio" name="broken_window_panes" value="0" >No</input></td></tr>
<tr><td>5.4.2 Any crack in the walls </td><td><input type="radio" name="cracks_in_wall" checked="checked" value="1" >Yes</input><br /><input type="radio" name="cracks_in_wall" value="0" >No</input></td></tr>
<tr><td>5.4.3 Garbage lying around</td><td><input type="radio" name="garbage_lying_around" checked="checked" value="1" >Yes</input><br /><input type="radio" name="garbage_lying_around" value="0" >No</input></td></tr>
<tr><td>5.4.4 Any signs of leakage in the ceiling</td><td><input type="radio" name="leakage_in_ceiling" checked="checked" value="1" >Yes</input><br /><input type="radio" name="leakage_in_ceiling" value="0" >No</input></td></tr>
<tr><td>5.4.5 Any cracks in the ceiling</td><td><input type="radio" name="cracks_in_ceiling" checked="checked" value="1" >Yes</input><br /><input type="radio" name="cracks_in_ceiling" value="0" >No</input></td></tr>


<tr><td>5.5 Classroom Situation</td></tr>
<tr><td>5.5.1 Classroom adequately ventilated </td><td><input type="radio" name="classroom_ventilated" checked="checked" value="1" >Yes</input><br /><input type="radio" name="classroom_ventilated" value="0" >No</input></td></tr>
<tr><td>5.5.2 Enough light (natural/artificial) to read easily </td><td><input type="radio" name="light_availability" checked="checked" value="1" >Yes</input><br /><input type="radio" name="light_availability" value="0" >No</input></td></tr>
<tr><td>5.5.3 Temperature of the room reasonably bearable</td><td><input type="radio" name="temperature_reasonably_bearable" checked="checked" value="1" >Yes</input><br /><input type="radio" name="temperature_reasonably_bearable" value="0" >No</input></td></tr>
<tr><td>5.5.4 Children seatd in comfortable manner</td><td><input type="radio" name="children_seated_comfortably" checked="checked" value="1" >Yes</input><br /><input type="radio" name="children_seated_comfortably" value="0" >No</input></td></tr>
<tr><td>5.5.5.	Time table available</td><td><input type="radio" name="time_table_available" checked="checked" value="1" >Yes</input><br /><input type="radio" name="time_table_available" value="0" >No</input></td></tr>
<tr><td>5.5.6.	Any information related to student achievement available</td><td><input type="radio" name="student_achievement_info" checked="checked" value="1" >Yes</input><br /><input type="radio" name="student_achievement_info" value="0" >No</input></td></tr>



<tr><td>5.6.	Outdoor space</td></tr>
<tr><td>5.6.1.	Boundary wall around the school</td><td><input type="radio" name="boundary_wall" checked="checked" value="1" >Yes</input><br /><input type="radio" name="boundary_wall" value="0" >No</input></td></tr>
<tr><td>5.6.2.	Gate installed and functional </td><td><input type="radio" name="gate_installed" checked="checked" value="1" >Yes</input><br /><input type="radio" name="gate_installed" value="0" >No</input></td></tr>
<tr><td>5.6.3.	Sufficient space for children to play</td><td><input type="radio" name="children_playing_space" checked="checked" value="1" >Yes</input><br /><input type="radio" name="children_playing_space" value="0" >No</input></td></tr>
<tr><td>5.6.4.	Any plantation in the school</td><td><input type="radio" name="plantation_in_school" checked="checked" value="1" >Yes</input><br /><input type="radio" name="plantation_in_school" value="0" >No</input></td></tr>
<tr><td>5.6.5.	Any hazards (e.g. ditches, broken glass, etc.)</td><td><input type="radio" name="hazards_around" checked="checked" value="1" >Yes</input><br /><input type="radio" name="hazards_around" value="0" >No</input></td></tr>
<tr><td>5.6.6.	Regular Assembly  </td><td><input type="radio" name="regular_assembly" checked="checked" value="1" >Yes</input><br /><input type="radio" name="regular_assembly" value="0" >No</input></td></tr>
<tr><td>5.6.7.	Any co-curricular activity organized during last quarter </td>
	<td>
		<input type="radio" name="extracurricular_activity_lastquarter" checked="checked" value="1" >Yes</input><br /><input type="radio" name="extracurricular_activity_lastquarter" value="0" >No</input><br />
...
<tr><td>5.7.2.	All classrooms have blackboard (well painted and functional) </td><td><input type="radio" name="blackboard_well_painted" checked="checked" value="1" >Yes</input><br /><input type="radio" name="blackboard_well_painted" value="0" >No</input></td></tr>
<tr><td>5.7.3.	Cabinets or any other alternate storage for school records </td><td><input type="radio" name="storage_for_school_records" checked="checked" value="1" >Yes</input><br /><input type="radio" name="storage_for_school_records" value="0" >No</input></td></tr>
...
<tr><td>6.1 The School has a notified SMC</td><td><input type="radio" name="has_notified_smc" checked="checked" value="1" >Yes</input><br /><input type="radio" name="has_notified_smc" value="0" >No</input></td></tr>
...
<tr><td>6.11.	Community contribution/support to school in any kind/form</td>
	<td>
		<input type="radio" name="community_contribution_to_school" checked="checked" value="1" >Yes</input><br /><input type="radio" name="community_contribution_to_school" value="0" >No</input><br />
	</td>
</tr>
<tr><td></td>
	<td>
