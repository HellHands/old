...
<?= $this->Form->create('mnform', array('url' => array('controller' => 'MonitoringForms201516', 'action' => 'add'))); ?>
...
<div class="row">
	<div class="form-group col-md-4">
  	...
  	<div class="form-group col-md-9">
	  	<?= $this->Form->input('school_name', array('label' => 'School Name', 'placeholder' => 'School Name', 'class' => 'form-control')); ?>
  	</div>	
</div>  
...
<div class="row">
	<div class="form-group col-md-2">
  	...
  	<div class="form-group col-md-2">
  		...
  		'label' => 'Location', 
  		'options' => array('0' => 'Choose', '1' => 'Urban', '2' => 'Rural', '3' => 'Semi Urban/Rural'),
  		'class' => 'form-control')); ?>
  	</div>
...
<hr>
<p class="lead">Basic Facilities</p>
<div class="row">
	<div class="form-group col-md-4">
...
<div class="row">
	...
	<div class="form-group col-md-5">
		...
		'label' => 'Headcount of Teaching Staff', 
	...
	<div class="form-group col-md-5">
		...
		'label' => 'Headcount of Non-Teaching Staff', 
...
<div class="row">
	...
	<div class="form-group col-md-6">
		<?= $this->Form->input('dcname', array('label' => 'Data Collector Name', 'placeholder' => 'Data Collector Name', 'class' => 'form-control')); ?>
	</div>

	<div class="form-group col-md-5">
		<?= $this->Form->input('dccontact', array('label' => 'Data Collector Contact#', 'placeholder' => 'Data Collector Contact', 'class' => 'form-control')); ?>
	</div>	
</div>
...
<div class="row">
	<div class="form-group col-md-12">
		<p class="lead">Data Provider</p>		
	</div>
	<div class="form-group col-md-6">
		<?= $this->Form->input('dpname', array('label' => 'Data Provider Name', 'placeholder' => 'Data Provider Name', 'class' => 'form-control')); ?>
	</div>

	<div class="form-group col-md-6">
		<?= $this->Form->input('dpcnic', array('label' => 'Data Provider CNIC', 'placeholder' => 'Data Provider CNIC', 'class' => 'form-control')); ?>
	</div>
