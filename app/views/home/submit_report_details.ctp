<h1 class="heading-main"> Report Based On Baseline Survey for Cluster</h1>
...
<?php if(isset($school_oppurtunities)) { ?>
	<h4> Other Oppurtunities In Cluster:</h4>
	<table>
...
<?php if(isset($school_basics)) { ?>
	<h4> Cluster Basic Information</h4>
	<table>
...
<?php if(isset($school_rooms_other)) { ?>
	<h4> Cluster Rooms Information</h4>
	<table>
	...
	<tr><td>Total Number of Rooms in Use in Cluster</td><td><?php echo $school_rooms_other_sum['total_rooms_inuse_sum']?></td></tr>
	<tr><td>Total Number of Classrooms in Cluster</td><td><?php echo $school_rooms_other_sum['classrooms_sum']?></td></tr>
	<tr><td>Total Number of Office in Cluster</td><td><?php echo $school_rooms_other_sum['office_sum']?></td></tr>
	<tr><td>Total Number of Store in Cluster</td><td><?php echo $school_rooms_other_sum['store_sum']?></td></tr>
	<tr><td>Total Number of Unused Rooms in Cluster</td><td><?php echo $school_rooms_other_sum['unused_sum']?></td></tr>
	<tr><td>Total Number of Unsafe Rooms in Cluster</td><td><?php echo $school_rooms_other_sum['unsafe_sum']?></td></tr>
	<tr><td>Total Number of Other Rooms in Cluster</td><td><?php echo $school_rooms_other_sum['other_sum']?></td></tr>
	</table>
	
	<h4> School Rooms Information</h4>
	<table>
	<tr><td width=40%></td><td width=30%></td><td width=30%>% of Cluster</td></tr>
...
<?php if(isset($school_student_record)) { ?>
	<h4> Students Records in Cluster</h4>
	<table>
...
<?php if(isset($school_teacher_record)) { ?>
	<h4> Teachers Records in Cluster</h4>
	<table>
	<tr><th  width=40% style="background-color:#bbffdd;"></th><th style="background-color:#bbffdd;">Available</th><th style="background-color:#bbffdd;">Updated</th></tr>
...
<?php if(isset($school_smc_records)) { ?>
	<h4> SMC Records in Cluster</h4>
	<table>
	<tr><th  width=40% style="background-color:#bbffdd;"></th><th style="background-color:#bbffdd;">Available</th><th style="background-color:#bbffdd;">Updated</th></tr>
	<tr><td>SMC Register Available / Updated in No. of Schools in Cluster</td><td><?php echo $numberofschool_smc_register_available_cluster; ?></td><td><?php echo $numberofschool_smc_register_updated_cluster; ?></td></tr>
	<tr><td>SMC Notification Available / Updated in No. of Schools in Cluster</td><td><?php echo $numberofschool_smc_notif_available_cluster; ?></td><td>N/A</td></tr>
	<tr><td>SMC Guideline Available / Updated in No. of Schools in Cluster</td><td><?php echo $numberofschool_smc_guideline_available_cluster; ?></td><td>N/A</td></tr>
	<tr><td>SMC Bank Account Information Available / Updated in No. of Schools in Cluster</td><td><?php echo $numberofschool_smc_accountinfo_available_cluster; ?></td><td>N/A</td></tr>
	</table>
...
<?php if(isset($school_sip_other_records)) { ?>
	<h4> Other Records in Clusters</h4>
	<table>
	<tr><th  width=40% style="background-color:#bbffdd;"></th><th style="background-color:#bbffdd;">Available</th><th style="background-color:#bbffdd;">Updated</th></tr>
	<tr><td>Visitors Book Available / Updated in no. of schools in cluster</td><td><?php echo $numberofschool_vb_available_cluster; ?></td><td><?php echo $numberofschool_vb_updated_cluster; ?></td></tr>
	<tr><td>SEMIS School Form Available / Updated in no. of schools in cluster</td><td><?php echo $numberofschool_ss_form_available_cluster; ?></td><td><?php echo $numberofschool_ss_form_updated_cluster; ?></td></tr>
	<tr><td>Textbooks Distribution form Available / Updated in no. of schools in cluster</td><td><?php echo $numberofschool_tb_distribution_available_cluster; ?></td><td><?php echo $numberofschool_tb_distribution_updated_cluster; ?></td></tr>
	<tr><td>Asset / Stock Register Available / Updated in no. of schools in cluster</td><td><?php echo $numberofschool_as_register_available_cluster; ?></td><td><?php echo $numberofschool_as_register_updated_cluster; ?></td></tr>
	<tr><td>School Improvement Plan (SIP)  Available / Updated in no. of schools in cluster</td><td><?php echo $numberofschool_sip_available_cluster; ?></td><td><?php echo $numberofschool_sip_updated_cluster; ?></td></tr>
	</table>
...
<?php if(isset($school_enrollment_this_year)) { ?>
	<h4> Grade Wise Enrollment This Year in Cluster( Boys ) </h4>
	<table>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_katchi_boys'])/($school_enrollment_this_year_sum['gwe_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_1_boys'])/($school_enrollment_this_year_sum['gwe_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_2_boys'])/($school_enrollment_this_year_sum['gwe_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_3_boys'])/($school_enrollment_this_year_sum['gwe_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_4_boys'])/($school_enrollment_this_year_sum['gwe_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_5_boys'])/($school_enrollment_this_year_sum['gwe_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_6_boys'])/($school_enrollment_this_year_sum['gwe_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_7_boys'])/($school_enrollment_this_year_sum['gwe_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_8_boys'])/($school_enrollment_this_year_sum['gwe_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_8_boys'])/($school_enrollment_this_year_sum['gwe_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<h4> Grade Wise Enrollment This Year in Cluster( Girls ) </h4>
	<table>
	<tr><th>Katchi </th><th>Class I</th><th>Class II</th><th>Class III</th><th>Class IV</th><th>Class V</th><th>Class VI</th><th>Class VII</th><th>Class VIII</th><th>Total</th></tr>
	<tr>
	<td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_katchi_girls'])/($school_enrollment_this_year_sum['gwe_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_1_girls'])/($school_enrollment_this_year_sum['gwe_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_2_girls'])/($school_enrollment_this_year_sum['gwe_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_3_girls'])/($school_enrollment_this_year_sum['gwe_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_4_girls'])/($school_enrollment_this_year_sum['gwe_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_5_girls'])/($school_enrollment_this_year_sum['gwe_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_6_girls'])/($school_enrollment_this_year_sum['gwe_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_7_girls'])/($school_enrollment_this_year_sum['gwe_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_8_girls'])/($school_enrollment_this_year_sum['gwe_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwe_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwe_8_girls'])/($school_enrollment_this_year_sum['gwe_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_enrollment_last_year)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_katchi_boys'])/($school_enrollment_last_year_sum['tely_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_1_boys'])/($school_enrollment_last_year_sum['tely_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_2_boys'])/($school_enrollment_last_year_sum['tely_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_3_boys'])/($school_enrollment_last_year_sum['tely_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_4_boys'])/($school_enrollment_last_year_sum['tely_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_5_boys'])/($school_enrollment_last_year_sum['tely_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_6_boys'])/($school_enrollment_last_year_sum['tely_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_7_boys'])/($school_enrollment_last_year_sum['tely_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_8_boys'])/($school_enrollment_last_year_sum['tely_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_1_boys'])/($school_enrollment_last_year_sum['tely_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_katchi_girls'])/($school_enrollment_last_year_sum['tely_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_1_girls'])/($school_enrollment_last_year_sum['tely_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_2_girls'])/($school_enrollment_last_year_sum['tely_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_3_girls'])/($school_enrollment_last_year_sum['tely_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_4_girls'])/($school_enrollment_last_year_sum['tely_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_5_girls'])/($school_enrollment_last_year_sum['tely_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_6_girls'])/($school_enrollment_last_year_sum['tely_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_7_girls'])/($school_enrollment_last_year_sum['tely_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_8_girls'])/($school_enrollment_last_year_sum['tely_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['tely_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['tely_1_girls'])/($school_enrollment_last_year_sum['tely_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_promoted)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_katchi_boys'])/($school_students_promoted_sum['ncp_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_1_boys'])/($school_students_promoted_sum['ncp_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_2_boys'])/($school_students_promoted_sum['ncp_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_3_boys'])/($school_students_promoted_sum['ncp_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_4_boys'])/($school_students_promoted_sum['ncp_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_5_boys'])/($school_students_promoted_sum['ncp_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_6_boys'])/($school_students_promoted_sum['ncp_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_7_boys'])/($school_students_promoted_sum['ncp_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_8_boys'])/($school_students_promoted_sum['ncp_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_8_boys'])/($school_students_promoted_sum['ncp_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_katchi_girls'])/($school_students_promoted_sum['ncp_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_1_girls'])/($school_students_promoted_sum['ncp_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_2_girls'])/($school_students_promoted_sum['ncp_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_3_girls'])/($school_students_promoted_sum['ncp_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_4_girls'])/($school_students_promoted_sum['ncp_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_5_girls'])/($school_students_promoted_sum['ncp_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_6_girls'])/($school_students_promoted_sum['ncp_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_7_girls'])/($school_students_promoted_sum['ncp_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_8_girls'])/($school_students_promoted_sum['ncp_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncp_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncp_8_girls'])/($school_students_promoted_sum['ncp_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_repeating)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_katchi_boys'])/($school_students_repeating_sum['ncr_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_1_boys'])/($school_students_repeating_sum['ncr_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_2_boys'])/($school_students_repeating_sum['ncr_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_3_boys'])/($school_students_repeating_sum['ncr_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_4_boys'])/($school_students_repeating_sum['ncr_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_5_boys'])/($school_students_repeating_sum['ncr_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_6_boys'])/($school_students_repeating_sum['ncr_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_7_boys'])/($school_students_repeating_sum['ncr_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_8_boys'])/($school_students_repeating_sum['ncr_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_8_boys'])/($school_students_repeating_sum['ncr_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_katchi_girls'])/($school_students_repeating_sum['ncr_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_1_girls'])/($school_students_repeating_sum['ncr_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_2_girls'])/($school_students_repeating_sum['ncr_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_3_girls'])/($school_students_repeating_sum['ncr_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_4_girls'])/($school_students_repeating_sum['ncr_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_5_girls'])/($school_students_repeating_sum['ncr_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_6_girls'])/($school_students_repeating_sum['ncr_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_7_girls'])/($school_students_repeating_sum['ncr_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_8_girls'])/($school_students_repeating_sum['ncr_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncr_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncr_8_girls'])/($school_students_repeating_sum['ncr_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_transferred)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_katchi_boys'])/($school_students_transferred_sum['nctos_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_1_boys'])/($school_students_transferred_sum['nctos_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_2_boys'])/($school_students_transferred_sum['nctos_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_3_boys'])/($school_students_transferred_sum['nctos_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_4_boys'])/($school_students_transferred_sum['nctos_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_5_boys'])/($school_students_transferred_sum['nctos_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_6_boys'])/($school_students_transferred_sum['nctos_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_7_boys'])/($school_students_transferred_sum['nctos_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_8_boys'])/($school_students_transferred_sum['nctos_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_8_boys'])/($school_students_transferred_sum['nctos_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_katchi_girls'])/($school_students_transferred_sum['nctos_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_1_girls'])/($school_students_transferred_sum['nctos_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_2_girls'])/($school_students_transferred_sum['nctos_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_3_girls'])/($school_students_transferred_sum['nctos_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_4_girls'])/($school_students_transferred_sum['nctos_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_5_girls'])/($school_students_transferred_sum['nctos_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_6_girls'])/($school_students_transferred_sum['nctos_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_7_girls'])/($school_students_transferred_sum['nctos_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_8_girls'])/($school_students_transferred_sum['nctos_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['nctos_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['nctos_8_girls'])/($school_students_transferred_sum['nctos_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_droppedout)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_katchi_boys'])/($school_students_droppedout_sum['ncdo_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_1_boys'])/($school_students_droppedout_sum['ncdo_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_2_boys'])/($school_students_droppedout_sum['ncdo_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_3_boys'])/($school_students_droppedout_sum['ncdo_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_4_boys'])/($school_students_droppedout_sum['ncdo_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_5_boys'])/($school_students_droppedout_sum['ncdo_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_6_boys'])/($school_students_droppedout_sum['ncdo_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_7_boys'])/($school_students_droppedout_sum['ncdo_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_8_boys'])/($school_students_droppedout_sum['ncdo_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_8_boys'])/($school_students_droppedout_sum['ncdo_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_katchi_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_katchi_girls'])/($school_students_droppedout_sum['ncdo_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_1_girls'])/($school_students_droppedout_sum['ncdo_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_2_girls'])/($school_students_droppedout_sum['ncdo_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_3_girls'])/($school_students_droppedout_sum['ncdo_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_4_girls'])/($school_students_droppedout_sum['ncdo_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_5_girls'])/($school_students_droppedout_sum['ncdo_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_6_girls'])/($school_students_droppedout_sum['ncdo_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_7_girls'])/($school_students_droppedout_sum['ncdo_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_8_girls'])/($school_students_droppedout_sum['ncdo_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncdo_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncdo_8_girls'])/($school_students_droppedout_sum['ncdo_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_attendance_today)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_katchi_boys'])/($school_students_attendance_today_sum['gwat_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_1_boys'])/($school_students_attendance_today_sum['gwat_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_2_boys'])/($school_students_attendance_today_sum['gwat_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_3_boys'])/($school_students_attendance_today_sum['gwat_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_4_boys'])/($school_students_attendance_today_sum['gwat_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_5_boys'])/($school_students_attendance_today_sum['gwat_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_6_boys'])/($school_students_attendance_today_sum['gwat_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_7_boys'])/($school_students_attendance_today_sum['gwat_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_8_boys'])/($school_students_attendance_today_sum['gwat_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_8_boys'])/($school_students_attendance_today_sum['gwat_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_1_girls'])/($school_students_attendance_today_sum['gwat_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_2_girls'])/($school_students_attendance_today_sum['gwat_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_3_girls'])/($school_students_attendance_today_sum['gwat_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_4_girls'])/($school_students_attendance_today_sum['gwat_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_5_girls'])/($school_students_attendance_today_sum['gwat_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_6_girls'])/($school_students_attendance_today_sum['gwat_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_7_girls'])/($school_students_attendance_today_sum['gwat_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_8_girls'])/($school_students_attendance_today_sum['gwat_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['gwat_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['gwat_8_girls'])/($school_students_attendance_today_sum['gwat_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_students_absent_month)) { ?>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_katchi_boys'])/($school_students_absent_month_sum['ncna_katchi_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_1_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_1_boys'])/($school_students_absent_month_sum['ncna_1_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_2_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_2_boys'])/($school_students_absent_month_sum['ncna_2_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_3_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_3_boys'])/($school_students_absent_month_sum['ncna_3_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_4_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_4_boys'])/($school_students_absent_month_sum['ncna_4_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_5_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_5_boys'])/($school_students_absent_month_sum['ncna_5_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_6_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_6_boys'])/($school_students_absent_month_sum['ncna_6_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_7_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_7_boys'])/($school_students_absent_month_sum['ncna_7_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_8_boys'])/($school_students_absent_month_sum['ncna_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_8_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_8_boys'])/($school_students_absent_month_sum['ncna_8_boys_sum']))*100,2)).'% of Cluster )'?>
	</td>
	...
	<tr>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_katchi_boys'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_katchi_girls'])/($school_students_absent_month_sum['ncna_katchi_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_1_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_1_girls'])/($school_students_absent_month_sum['ncna_1_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_2_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_2_girls'])/($school_students_absent_month_sum['ncna_2_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_3_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_3_girls'])/($school_students_absent_month_sum['ncna_3_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_4_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_4_girls'])/($school_students_absent_month_sum['ncna_4_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_5_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_5_girls'])/($school_students_absent_month_sum['ncna_5_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_6_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_6_girls'])/($school_students_absent_month_sum['ncna_6_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_7_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_7_girls'])/($school_students_absent_month_sum['ncna_7_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_8_girls'])/($school_students_absent_month_sum['ncna_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
	<td>
	<?php echo $enrollmentAttendance['EnrollmentAttendance']['ncna_8_girls'].'<br />('.(round((($enrollmentAttendance['EnrollmentAttendance']['ncna_8_girls'])/($school_students_absent_month_sum['ncna_8_girls_sum']))*100,2)).'% of Cluster )'?>
	</td>
...
<?php if(isset($school_average_attendance)) { ?>
	<h4> School Average Attendance in Cluster ( Boys ) </h4>
	<table>
	<tr><th>Katchi </th><th>Class I</th><th>Class II</th><th>Class III</th><th>Class IV</th><th>Class V</th><th>Class VI</th><th>Class VII</th><th>Class VIII</th><th>Total</th></tr>
	<tr>
	<td>
	...
	<h4> School Average Attendance in Cluster ( Girls ) </h4>
	<table>
	<tr><th>Katchi </th><th>Class I</th><th>Class II</th><th>Class III</th><th>Class IV</th><th>Class V</th><th>Class VI</th><th>Class VII</th><th>Class VIII</th><th>Total</th></tr>
	<tr>
	<td>
...
<?php if(isset($school_numberof_teachers)) { ?>
	...
	<tr><td><strong>Total Number of Teachers in the Cluster</strong></td><td><?php echo $cluster_teachers_sum?></td></tr>
	</table>
	<h4>Teachers In School</h4>
	<table>
	<tr><td width=40%></td><td width="30%"></td><td width="30%"><strong>% in Cluster</strong></td></tr>
...
<?php if(isset($school_toilets_facility)) { ?>
	<h4> Toilets In Cluster</h4>
	<table>
	<tr><td width=50%>Toilets Available To Students in No. of Schools:</td><td><?php echo $toilets_available_count?></td></tr>
	<tr><td>Total Number of Toilet seats / WCs Available in Cluster</td><td><?php echo $number_toilets_available_sum['sum_toilets_count']?></td></tr>
	<tr><td>The Toilet Clean with No Smell in Cluster in No. of Schools:</td><td><?php echo $toilet_cleanliness_count?></td></tr>
...
<?php if(isset($school_water_facility)) { ?>
	<h4> Water Provision in Cluster</h4>
	<table>
...
<?php if(isset($school_electricity_facility)) { ?>
	<h4> Electricity and Fixtures in Clusters</h4>
	<table>
...
<?php if(isset($school_safety_facility)) { ?>
	<h4> Services, Maintainance and Safety in Cluster</h4>
	<table>
...
<?php if(isset($school_classroom_facility)) { ?>
	<h4> Classroom Situation in Clusters</h4>
	<table>
...
<?php if(isset($school_outdoor_facility)) { ?>
	<h4> Outdoor Space in Cluster</h4>
	<table>
...
<?php if(isset($school_furniture_facility)) { ?>
	<h4> Furniture and Fixtures in Cluster</h4>
	<table>
...
<?php if(isset($school_smc_basicinfo)) { ?>
	<h3> School Management Committee Basic Informatoion for the Cluster</h3>
	<table>
	...
	<tr><td>Number of SMC Members in Cluster:(Male)</td><td><?php echo $smc_cluster_basicinfo[0]['smc_members_male_sum']?></td></tr>
	<tr><td>Number of SMC Members in Cluster:(Female)</td><td><?php echo $smc_cluster_basicinfo[0]['smc_members_female_sum']?></td></tr>
	<tr><td>Number of SMC Members in Cluster:(Total)</td><td><?php echo ($smc_cluster_basicinfo[0]['smc_members_male_sum'])+($smc_cluster_basicinfo[0]['smc_members_female_sum'])?></td></tr>
	<tr><td>Number of SMC Meetings / Visits to Schools this Year in Cluster</td><td><?php echo ($smc_cluster_basicinfo[0]['smc_visits_this_year_sum'])?></td></tr>
	<tr><td>Total Number of SMC Meetings / Visits to Schools last Year  in Cluster</td><td><?php echo ($smc_cluster_basicinfo[0]['smc_visits_last_year_sum'])?></td></tr>
	...
	<table>
	<tr><td width=40%></td><td width=30%></td><td width=30%>% of Cluster(where applicable)</td></tr>
...
<?php if(isset($school_smc_funding)) { ?>
	<h3> SMC Bank and Budget Information for Cluster</h3>
	<table>
	<tr><td width=50% style="background-color:#bbffdd;">Amount of Funding Recieved During Current Year For the Cluster:</td><td style="background-color:#bbffdd;"><?php echo $smc_cluster_funding['funding_recieved_current_year_sum']?></td></tr>
	<tr><td width=50% style="background-color:#bbffdd;">Amount of Funding Recieved During last Year For the Cluster:</td><td style="background-color:#bbffdd;"><?php echo $smc_cluster_funding['funding_recieved_current_year_sum']?></td></tr>
	</table>
