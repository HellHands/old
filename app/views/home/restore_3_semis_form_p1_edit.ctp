...
<label>New SEMIS Code</label></td><td><input readonly="readonly" class="semis_code nonnegative number maxnine"  type="number" id="school_semis_new" name="school_semis_new"  value="<?php echo $schools['Univ2012a']['school_id']; ?>" ></input>
<script>
...
<tr><td><label>Coordinates Longitude</label></td><td><input readonly="readonly" type="text" placeholder="22-22.2222" name="coord_long" value="<?php echo $schools['Univ2012a']['coord_long'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td><label>Coordinates Longitde</label></td><td><input readonly="readonly" type="text" placeholder="22-22.2222" name="coord_lat" value="<?php echo $schools['Univ2012a']['coord_lat'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td colspan=2 >
					<h6><b>Q1. School Basic Information</b></h6>
</td></tr>
<tr><td><label>District</label></td><td>
						<select disabled name="bi_school_district" id="district_code">
							<option selected="selected" value="0">All</option>
							<?php foreach($districts as $district) { ?>
								<option <?php if($district['SemisCodeDistrict']['district_id'] == $schools['Univ2012a']['DistrictID']) { ?> selected="selected" <?php } ?> <?php if($schools['Univ2012a']['DistrictID'] == $district['SemisCodeDistrict']['district_id']) { ?><?php } ?> value="<?php echo $district['SemisCodeDistrict']['district_id']; ?>"><?php echo $district['SemisCodeDistrict']['district']; ?></option>
							<?php } ?>
						</select>
						</td>
						</tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator" id="tehsil" >
		<tr>
			...
			<td width="25%">
				<select disabled name="bi_school_taluka" id="tehsil_code">
					<option selected="selected" value="0">All</option>
					<?php foreach($tehsils as $tehsil) { if($tehsil['CodesForDistrictAndTehsil']['district_id'] == $schools['Univ2012a']['DistrictID']) { ?>
						<option <?php if($tehsil['CodesForDistrictAndTehsil']['tehsil_id'] == $schools['Univ2012a']['TehsilID']) { ?> selected="selected" <?php } ?> value="<?php echo $tehsil['CodesForDistrictAndTehsil']['tehsil_id']; ?>"><?php echo $tehsil['CodesForDistrictAndTehsil']['tehsil']; ?></option>
					<?php } } ?>
				</select>
			</td>
			<td width="25%">
...
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator" id="unioncouncil" >	
		<tr>
			...
			<td width="25%">
				<select disabled name="bi_school_uc" id="union_council_id" >
					<option selected="selected" value="0">All</option>
					<?php foreach($union_councils as $union_council) { if($schools['Univ2012a']['TehsilID'] == $union_council['CodesForUc']['tehsil_id']) { ?>
						<option <?php if($union_council['CodesForUc']['uc_id'] == $schools['Univ2012a']['UnionCouncilID']) { ?> selected="selected" <?php } ?> value="<?php echo $union_council['CodesForUc']['uc_id'];?>" >
...
<tr><td><label>(c). Tappa</label></td><td><input type="text" name="bi_school_tappa" value="" ></input></td></tr>
<tr><td><label>(d). Deh</label></td><td><input type="text" name="bi_school_deh" value="" ></input></td></tr>
<tr><td><label>(e). Village / Area</label></td><td><input readonly="readonly" type="text" name="bi_school_village_mohallah" value="<?php echo $schools['Univ2012a']['Village-Mohalla']; ?>" ></input></td></tr>
...
<tr><td><label>(f). School Name with Prefix</label></td><td><input readonly="readonly" type="text" name="bi_school_name" value="<?php echo $schools['Univ2012a']['Prefix'].' - '.$schools['Univ2012a']['SchoolName']; ?>" ></input></td></tr>
<tr><td><label>(g). Address</label></td><td><input type="text" readonly="readonly" name="bi_school_address" value="<?php echo $schools['Univ2012a']['SchoolAddress']; ?>" ></input></td></tr>
<tr><td><label>(h). Phone Number</label></td><td><input type="text" readonly="readonly" name="bi_school_phone_number" class="nonnegative number " maxlength="11" value="<?php echo $schools['Univ2012a']['Phone']; ?>" ></input></td></tr>
<?php }else{ */ ?>
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator">
<label>New SEMIS Code</label></td><td><input readonly="readonly" class="semis_code nonnegative number maxnine"  type="number" id="school_semis_new" name="school_semis_new"  value="<?php echo $schools['SemisUniversal201415']['school_semis_new']; ?>" ></input>
<script>
$('.semis_code_button').click(function() {
	var semis_code_new = $('#school_semis_new').val(); 
	if(semis_code_new == '')
...
<div id="table_first">
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator" id="" onload="init();" >
<tr><td><label>Coordinates Longitude</label></td><td><input <?php if(!empty($schools['SemisUniversal201415']['coord_long'])) { ?> readonly="readonly" <?php } ?> type="text" placeholder="22-22.2222" name="coord_long" value="<?php echo $schools['SemisUniversal201415']['coord_long'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td><label>Coordinates Longitde</label></td><td><input <?php if(!empty($schools['SemisUniversal201415']['coord_lat'])) { ?> readonly="readonly" <?php } ?> type="text" placeholder="22-22.2222" name="coord_lat" value="<?php echo $schools['SemisUniversal201415']['coord_lat'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td colspan=2 >
					<h6><b>Q1. School Basic Information</b></h6>
</td></tr>
<tr><td><label>District</label></td><td>
...
<tr><td><label>(c). Tappa</label></td><td><input type="text" readonly="readonly" name="bi_school_tappa" value="<?php foreach ($tappas as $tappa) { if($schools['SemisUniversal201415']['bi_school_tappa'] == $tappa['CodesForTappa']['TappaID']) { echo $tappa['CodesForTappa']['Tappa']; } } ?>" ></input></td></tr>
<?php }else{ ?>
		<tr>
			<td>Tappa</td>
			<td>
				<select disabled name="bi_school_tappa" id="tappa_id" >
...
<tr><td><label>(d). Deh</label></td><td><input readonly="readonly" type="text" name="bi_school_deh" value="<?php foreach ($dehs as $deh) { if($schools['SemisUniversal201415']['bi_school_deh'] == $deh['CodesForDeh']['DehID']) { echo $deh['CodesForDeh']['Deh']; } } ?>" ></input></td></tr>
<?php }else{ ?>
		<tr>
			<td>Tappa</td>
			<td>
				<select disabled name="bi_school_tappa" id="tappa_id" >
					<option selected="selected" value="0">Not Available</option>
					<?php foreach($dehs as $deh) { if($schools['SemisUniversal201415']['bi_school_taluka'] == $deh['CodesForDeh']['DehID']) { ?>
...
<?php } ?>
<tr><td><label>(e). Village / Area</label></td><td><input  <?php if(!empty($schools['SemisUniversal201415']['bi_school_address'])) { ?> readonly="readonly" <?php } ?> type="text" name="bi_school_village_mohallah" value="<?php echo $schools['SemisUniversal201415']['bi_school_village_mohallah']; ?>" ></input></td></tr>
<!--tr><td><label>Q5. National Assembly</label></td><td><input type="number" class="nonnegative number maxthree" name="bi_school_na" value="" ></input></td></tr>
<tr><td><label>Q6. Provincial Sindh</label></td><td><input type="number" class="nonnegative number maxthree"  name="bi_school_ps" value="" ></input></td></tr-->
<tr><td><label>(f). School Name with Prefix</label></td><td><input <?php if(!empty($schools['SemisUniversal201415']['bi_school_name'])) { ?> readonly="readonly" <?php } ?> type="text" name="bi_school_name" value="<?php echo $schools['SemisUniversal201415']['bi_school_name']; ?>" ></input></td></tr>
<tr><td><label>(g). Address</label></td><td><input type="text" <?php if(!empty($schools['SemisUniversal201415']['bi_school_address'])) { ?> readonly="readonly" <?php } ?> name="bi_school_address" value="<?php echo $schools['SemisUniversal201415']['bi_school_address']; ?>" ></input></td></tr>
<tr><td><label>(h). Phone Number</label></td><td><input type="text" <?php if(!empty($schools['SemisUniversal201415']['bi_school_phone_number'])) { ?> readonly="readonly" <?php } ?> name="bi_school_phone_number" class="nonnegative number " maxlength="11" value="<?php echo $schools['SemisUniversal201415']['bi_school_phone_number']; ?>" ></input></td></tr>
<?php /* } */ ?>
<tr><td colspan=2 ><h6><b>Q2. Information About Head of School / Head Teacher</b></h6></td></tr>
<tr><td><label>a. Name</label></td><td><input type="text" name="hti_name" value="" ></input></td></tr>
<tr><td><label>b. CNIC</label></td><td><input type="text" name="hti_cnic" value="" ></input></td></tr>
<tr>
<td>
<label>c. Designation</label></td>
<td>
			<input type="radio" name="hti_designation" value="1" >Head Teacher</input><br>
			...
			<input type="radio" name="hti_designation" value="4" >Supervisor</input><br>
...
<tr><td><label>e. Contact Number (Tele/Mob)</label></td><td><input type="text" name="hti_number" maxlength="11" value="" ></input></td></tr>
<tr><td><label>f. Email</label></td><td><input type="text" name="hti_email" value="" ></input></td></tr>
<tr><td><label>Q3. (a) School Status</label></td>
<td>
...
<td>
	<label>Q3. (b) If School is Temporary Closed or Permanently Closed Date of Closure</label>
</td>
<td>			
	<div id="well">
...
<label>Q3. (c) If School is permanently or Temporary closed select the reason </label></td>
<td>
			...
			<input type="radio" class="dsi_closure_reason" name="dsi_closure_reason" value="8" >Other (Specify)</input><br>
			</div><br>
			<script>
			...
			<input class="showifotherdsi_closure_reason" type="text" name="dsi_closure_reason_specify" value="" style="display:none;" ></input><br>
</td>
</tr>
</table>
</div>
...
<td>
			<input type="radio" name="dsi_level" value="1" >Primary</input><br>
			<input type="radio" name="dsi_level" value="2" >Middle</input><br>
			<input type="radio" name="dsi_level" value="3" >Elementary</input><br>
...
<td>
			...
			<input type="radio" name="dsi_sch_sne" value="2" >No</input><br></td></tr>
<script>
...
<table class="CSSTableGenerator">
		<tr class="sne_available_display" style="display:none;" ><td style="width:14%;" ><label >Number of Sanctioned posts</label></td><td style="width:13%;" ><input type="number" class="nonnegative number maxnine dsi_sne_available_number" name="dsi_sne_available_number" value="" ></input><br></td></tr>
</table>
<table class="CSSTableGenerator">			
<tr><td><label>Q7. Administration</label></td>
<td>			<input type="radio" name="dsi_sch_admin" value="3" >ADO Male</input><br>
<td>			<input type="radio" name="dsi_sch_admin" value="4" >ADO Female</input><br>
<td>			<input type="radio" name="dsi_sch_admin" value="5" >DO Elementary</input><br>
...
<tr><td><label>Q8. Gender</label></td>
<td>			<input type="radio" name="dsi_sch_gender" value="1" >Boys</input><br>
			<input type="radio" name="dsi_sch_gender" value="2" >Girls</input><br>
			<input type="radio" name="dsi_sch_gender" value="3" >Mixed School</input><br></td></tr>
...
<tr class="urdumediumenrollment_display" style="display:none;" ><td><label>Urdu Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_urdu nonnegative number" name="dsi_enrollment_urdu" value="" ></input><br></td></tr>
<tr class="sindhimediumenrollment_display" style="display:none;" ><td><label>Sindhi Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_sindhi nonnegative number" name="dsi_enrollment_sindhi" value="" ></input><br></td></tr>
<tr class="englishmediumenrollment_display" style="display:none;" ><td><label>English Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_english nonnegative number" name="dsi_enrollment_english" value="" ></input><br></td></tr>

<tr><td><label>Q10. Shift</label></td>
<td>
			<input type="radio" name="dsi_shift" value="1" >Morning</input><br>
			<input type="radio" name="dsi_shift" value="2" >Afternoon</input><br>
			<input type="radio" name="dsi_shift" value="3" >Both Shifts</input><br>
</td>
</tr>
<tr>
<td>
...
<td>
			<input type="radio" name="dsi_branch_school" value="1" >Yes</input><br>
			<input type="radio" name="dsi_branch_school" value="2" >No</input><br>
</td>
</tr>
<script>
...
<table class="CSSTableGenerator">
		<tr class="branch_school_display nonnegative number maxnine" style="display:none;" ><td style="width:14%;" ><label >a. SEMIS Code of Main School</label></td><td style="width:13%;" ><input type="number" class="nonnegative number maxnine dsi_main_school_semis_code" name="dsi_main_school_semis_code" value="" ></input><br></td></tr>
		<tr class="branch_school_display" style="display:none;" ><td style="width:14%;" ><label>b. Name of Main School</label></td><td style="width:13%;" ><input type="text" class="dsi_main_school_semis_code" name="dsi_main_school_name" value="" ></input><br></td></tr>
</table>
<table class="CSSTableGenerator" >
...
<tr><td><label>(a) Ownership</label></td>
			<td>
				<input type="radio" name="sbi_ownership" value="1" >Government Building</input><br>
				<input type="radio" name="sbi_ownership" value="2" >Shared with other Government School Building</input><br>
...
$('input[name=sbi_ownership]').on('keyup keypress blur change', function() {
	...
	if(sbi_ownership == '4')
	{
		$('.sbi_otherbuildingdisplay').attr('style','display:block;');
	}
});
</script>
</table>
<table class="CSSTableGenerator">
<tr style="display:none;" class="sbi_nobuildingdisplay" ><td><label>(a) If No Building then School Placed</label></td>
			<td>
...
<td>
	<label>(a) If Other Building (specify)</label>
			...
			<td>
				<input type="text" class="nonnegative number maxnine" id="sbi_other_building_specify" name="sbi_other_building_specify" value="" ></input>
			</td>
</tr>
</table>
<table class="CSSTableGenerator">
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td colspan=2><label>(b) option 1,2,3 or 4 selected then fill following details</label></td></tr>
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(b) last Construction Year</label></td>
	<td>
		<div class="well">
...
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(c) Type of Building</label></td>
			<td>
				<input type="radio" name="sbi_school_building_construction_type" value="1" >Pakka/RCC/TierGuarder</input>
...
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(d) Condition of the Building</label></td>
			<td>
...
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(e) Total Number of Rooms (All Rooms)</label></td><td><input type="number" class="nonnegative number maxthree" id="sbi_school_building_total_rooms" name="sbi_school_building_total_rooms" value="" ></input></td></tr>
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(f) Total Number of Rooms used as Class Rooms</label></td><td><input type="number" class="nonnegative number maxthree" id="sbi_school_building_class_rooms" name="sbi_school_building_class_rooms" value="" ></input></td></tr>
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(g) Rooms utilized for other then learning / teaching purpose</label></td><td><input type="number" class="nonnegative number maxthree" id="sbi_school_building_other_then_learning" name="sbi_school_building_other_then_learning" value="" ></input></td></tr>
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>(g) Purpose other then teaching / learning</label></td>
			<td>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="1" >NGO</input>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="2" >District Administration Office</input>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="3" >Occupied by Villagers</input>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="4" >Community Centre</input>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="5" >Vocational Training Centre</input>
				<input type="checkbox" class="sbi_purpose_other_then_teaching" name="sbi_purpose_other_then_teaching" value="6" >Other</input>
			</td>
</tr>
			<script>
					$('.sbi_purpose_other_then_teaching').on('keyup keypress blur change', function() {
						var sbi_purpose_other_then_teaching = parseInt($('input[name=sbi_purpose_other_then_teaching]:checked').val());
						
						if(sbi_purpose_other_then_teaching == '6')
						{
							$('.sbi_school_building_condition_specify').val('');
							$('.sbi_school_building_condition_specify').attr('style','display:block;');
						}else
						{
							$('.sbi_school_building_condition_specify').val('');
							$('.sbi_school_building_condition_specify').attr('style','display:none;');
						}
					});
			</script>
			<tr class="sbi_school_building_condition_specify" style="display:none;" >
				<td colspan="6" >Specify Other Record Available at School</td>
				<td colspan="5" >
					<input type="text" name="sbi_school_building_condition_specify" class="sbi_school_building_condition_specify" value="" ></input>
				</td>
			</tr>
<tr>
	<td colspan=2 >
...
<tr><td><label>(b) Are the Toilets Available</label></td>
			<td>
...
<tr style="display:none;" class="sbf_schooltoiletsdisplay" ><td><label>(b) If Toilets Available Write Number of Functional</label></td>
			<td>
...
<tr style="display:none;" class="sbf_schooltoiletsdisplay" ><td><label>(b) If Toilets Available Write Number non functional</label></td>
			<td>
...
<tr><td><label>Government Male Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_govt_teacher_number_male" type="number" name="sti_govt_teacher_number_male" value="" ></input></td></tr>
<tr><td><label>Non Government Male Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_non_govt_teacher_number_male" type="number" name="sti_non_govt_teacher_number_male" value="" ></input></td></tr>
<tr><td><label>Government Female Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_govt_teacher_number_female" type="number" name="sti_govt_teacher_number_female" value="" ></input></td></tr>
<tr><td><label>Non Government Female Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_non_govt_teacher_number_female" type="number" name="sti_non_govt_teacher_number_female" value="" ></input></td></tr>
<tr><td><label>Total Teachers</label></td><td><input class="total_teachers" type="number" readonly="readonly" name="sti_teacher_mf_total" value="" ></input></td></tr>

<tr><td colspan=2 >
					<h6><b>Q14. (b) Total Number of Non Teaching Staff </b></h6>
</td></tr>
<tr><td><label>Non Teaching Staff Male</label></td><td><input type="number" class="non_teacher_number nonnegative number maxthree" id="sti_govt_non_teaching_number_male" name="sti_govt_non_teaching_number_male" value="" ></input></td></tr>
<tr><td><label>Non Teaching Staff Female</label></td><td><input type="number" class="non_teacher_number nonnegative number maxthree" id="sti_govt_non_teaching_number_female" name="sti_govt_non_teaching_number_female" value="" ></input></td></tr>
<tr><td><label>Total Non Teaching Staff</label></td><td><input class="total_non_teachers" readonly="readonly" type="number" name="sti_govt_non_teaching_mf_total" value="" ></input></td></tr>

<tr><td><label>Signature of Data Provider / Enumerator</label></td><td>
...
<table border="0" cellpadding="0" cellspacing="0"  class="shrink CSSTableGenerator">
	...
	<tr>
		...
		<td colspan="5" >
			...
			<input type="radio" name="stuenr_source" value="" >4. No Formal Record</input><br>
		</td>
	</tr>
	<script>
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input class="stuenr_ele_total_b" readonly="readonly" type="number" name="stuenr_ele_total_b" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_ele_total_b']; ?>" ></input></td>
	</tr>
	<script>
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input class="stuenr_ele_total_g" readonly="readonly" type="number" name="stuenr_ele_total_g" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_ele_total_g']; ?>" ></input></td>
	</tr>
</table>
	<script>
...
<table border="0" cellpadding="0" cellspacing="0"  class="shrink CSSTableGenerator">
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input type="number" readonly="readonly" class="stuenr_sec_b_total" name="stuenr_sec_b_total" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_sec_b_total']; ?>" ></input></td>
	</tr>
	<script>
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input readonly="readonly" type="number" class="stuenr_sec_g_total" name="stuenr_sec_f_total" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_sec_f_total']; ?>" ></input></td>
	</tr>
	<script>
...
<table border="0" cellpadding="0" cellspacing="0" class="shrink CSSTableGenerator">
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input type="number" readonly="readonly" class="stuenr_hsec_m_total" name="stuenr_hsec_m_total" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_hsec_m_total']; ?>" ></input></td>
	</tr>
	<script>
	...
	<tr class="matchtotalenrollmentclass" >
		...
		<td><input type="number" readonly="readonly" class="stuenr_hsec_f_total" name="stuenr_hsec_f_total" value="<?php echo $semisEnrollment['SemisEnrollment201415']['stuenr_hsec_f_total']; ?>" ></input></td>
	</tr>
	<script>
...
<table border="0" cellpadding="0" cellspacing="0" class="shrink CSSTableGenerator" >
	...
	<tr>
		...
		<td><input type="number" readonly="readonly" class="sturep_total_b" name="sturep_total_b" value="<?php echo $semisEnrollment['SemisEnrollment201415']['sturep_total_b']; ?>" ></input></td>
	</tr>
	<script>
	...
	<tr>
		...
		<td class="" ><input class="sturep_total_g" readonly="readonly" type="number" name="sturep_total_g" value="<?php echo $semisEnrollment['SemisEnrollment201415']['sturep_total_g']; ?>" ></input></td>
	</tr>
	<script>
...
<tr>
	<td colspan=5 >
		<h6><b>Q17. List of Surrounding Government Schools [Schools within same premises or adjacent schools or where distance within 1500 Meters] </b></h6>
	</td>
</tr>
<tr>
	<td>S.No.</td>
...
<table border="0" cellpadding="0" cellspacing="0"  class="CSSTableGenerator">
<tr><td colspan="3"><h6><b>Q18. Total Number of Surrounding PPRS and Private Schools [Schools within same premises or adjacent schools or where distance within 1500 meters]</b></h6></td></tr>
<tr>
...
<tr>
	<td><input class="teachersnumbersfields nonnegative number maxthree"" type="number" value="0" name="asi_total_pprs_schools" ></input></td>
...
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator">
		...
		<tr>
			<td>Q19. Total School Area in Square Feet</td>
			<td><input type="number" name="sgi_sch_area_covered" class="nonnegative number maxsix" ></input></td>
		</tr>
		<tr>
			<td>Q20. SEMIS Code Displayed on Visible Location</td>
		...
		<tr>
			<td>Q21. Did the school receive Textbooks in academic year=? </td>
		...
		<tr>
			<td>Q22. Any Construction Work in the past academic year? </td>
		...
		<tr>
			<td>Q23. (a) Did this school receive girls stipends in last academic year? </td>
			<td>
		...
		<tr style="display:none;" class="sgi_sch_received_stipenddisplay" ><td><label>Q23. (b) If girls received stipends write number ? </label></td>
					<td>
						<input type="text" name="sgi_sch_received_stipend_12_13_number" value="" ></input>
					</td>
		</tr>
		
		<tr>
		<td>Q24. (a) Has school upgraded to next level in last academic year ?</td>
			<td>
				<input type="radio" class="sgi_is_school_upgraded" name="sgi_is_school_upgraded" <?php /* if($schools['SemisUniversal201415']['sgi_is_school_upgraded'] == 1) { ?> selected="selected" <?php  } */ ?> value="1">Yes</input>
				<input type="radio" class="sgi_is_school_upgraded" name="sgi_is_school_upgraded" <?php /* if($schools['SemisUniversal201415']['sgi_is_school_upgraded'] == 2) { ?> selected="selected" <?php } */ ?> value="2">No</input>
			</td>
		</tr>
		...
		<tr style="display:none;" class="sgi_sch_upgraded_level" ><td><label>Q24. (b) Write the upgraded level.</label></td>
					<td>
						<input type="text" class="sgi_sch_upgraded_level" name="sgi_sch_upgraded_level" value="" ></input>
					</td>
		</tr>
		
		<td>Q25. Is this school adopted ?</td>
			<td>
				<input type="radio" class="sgi_is_school_adopted" name="sgi_is_school_adopted" <?php /* if($schools['SemisUniversal201415']['sgi_is_school_adopted'] == 1) { ?> selected="selected" <?php } */ ?> value="1">Yes</input>
				<input type="radio" class="sgi_is_school_adopted" name="sgi_is_school_adopted" <?php /*if($schools['SemisUniversal201415']['sgi_is_school_adopted'] == 2) { ?> selected="selected" <?php } */ ?> value="2">No</input>
			</td>
		</tr>
		...
		<tr style="display:none;" class="sgi_sch_adopted_adopterdisplay" ><td><label>Q25. (a) If school adopted then adopter name.</label></td>
					<td>
						<input type="text" name="sgi_sch_adopted_adopter" value="" ></input>
					</td>
		</tr>
		<tr>
			<td>Q26. What is the DDO Code / Cost Centre of this school ? </td>
			<td>
				<input type="text" class="maxsix" name="sgi_school_ddo_code" value=""></input>
			</td>
		</tr>
	</table>
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator">
<tr><td colspan="2" ><h6><b>Q27. School Management Committee (SMC)</b></h6></td></tr>
<tr>
	<td>a. Is SMC Functional ?</td>
	<td>
		<input type="radio" name="smci_is_functional" <?php if($schools['SemisUniversal201415']['smci_is_functional'] == 1) { ?> selected="selected" <?php } ?> value="1">Yes</input>
		<input type="radio" name="smci_is_functional" <?php if($schools['SemisUniversal201415']['smci_is_functional'] == 2) { ?> selected="selected" <?php } ?> value="2">No</input>
	</td>
</tr>
<tr>
	<td>b. Has this School Got SMC Funds in last academic year ?</td>
	<td>
		<input type="radio" name="smci_received_smc" <?php if($schools['SemisUniversal201415']['smci_received_smc'] == 1) { ?> selected="selected" <?php } ?> value="1">Yes</input>
		<input type="radio" name="smci_received_smc" <?php if($schools['SemisUniversal201415']['smci_received_smc'] == 2) { ?> selected="selected" <?php } ?> value="2">No</input>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input class="maxsix" type="number" name="smci_bank_branch_code" class="nonnegative number" value=""></input>
	</td>
</tr>
<!--tr>
...
<tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator">
<tr><td colspan="3" ><h6><b>Q28. Write Total Number of following facilities available in School</b></h6></td></tr>
<tr>
	<td>Items</td>
	<td>Working</td>
	<td>Repairable</td>
...
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator">
<tr><td colspan="2" ><h6><b>Q29. Which of the following facilities are available in the School</b></h6></td></tr>
<tr>
	<td>Questions</td>
	<td>Response</td>
</tr>
...
<div class="page4" style="display:none;">
	<div class="page3">
		<table style="margin-left:-15px;" border="0" cellpadding="0" cellspacing="0" class="shrink CSSTableGenerator teacher_table grid_table wf">
				<tr><td style="width:50px;" >S.No.</td><td style="width:50px;" >Full Name</td><td style="width:50px;" >CNIC Number</td><td style="width:50px;" >Gender</td><td style="width:50px;" >Personal Number from AG Office</td><td style="width:50px;" >Date of Birth</td><td style="width:50px;" >Designation Code</td><td style="width:50px;" >BPS(Time Scale)</td><td style="width:50px;" >BPS (Actual Scale)</td><td style="width:50px;" >Date of Entry In this Government Service</td><td style="width:50px;" >BPS (at time of appointment)</td><td style="width:50px;" >Code for Type of Post</td><td style="width:50px;" >Highest Academic Qualification Code</td><td style="width:50px;" >Professional Training Code</td><td style="width:50px;" >On Detailment</td><td style="width:50px;" >Contact Number</td></tr>
		</table>
		...
		<table style="margin-left:-15px;" border="0" cellpadding="0" cellspacing="0" class="shrink CSSTableGenerator grid_table wf">
				...
				?>
				<input type="text" style="display:none;" name="total_merged_schools" value="<?php echo $count_merged; ?>" />
				<?php
				// $count_merged = 3;
				...
				<td><?php echo ($x+1); ?></td>
				<td><input type="text" name="merged_<?php echo ($x+1); ?>_bi_school_name" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['bi_school_name']; ?>" ></input></td>
				<td><input class="semis_code nonnegative number maxnine"  type="number" id="school_semis_new" name="merged_<?php echo ($x+1); ?>_school_semis_new"   value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['school_semis_new']; ?>"  ></input></td>
				<td>
					<select name="merged_<?php echo ($x+1); ?>_asi_school_type" >
				...
				<td>
					<select name="merged_<?php echo ($x+1); ?>_asi_school_merging_type" >
						<option value="1" >Same Premises</option>
						<option value="2" >Adjacent</option>
						<option value="3" >Within 500 Meters</option>
					</select>
				...
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_status" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_status'] == 1) { echo 'selected="selected"'; } ?> value="1" >Functional</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_status" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_status'] == 2) { echo 'selected="selected"'; } ?> value="2" >Temporary Closed</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_status" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_status'] == 3) { echo 'selected="selected"'; } ?> value="3" >Permanent Closed</input><br>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbi_ownership" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbi_ownership'] == 1) { echo 'selected="selected"'; } ?> value="1" >School has its own Government Building</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbi_ownership" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbi_ownership'] == 2) { echo 'selected="selected"'; } ?> value="2" >Other Government School Building (shared)</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbi_ownership" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbi_ownership'] == 3) { echo 'selected="selected"'; } ?> value="3" >Rented</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbi_ownership" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbi_ownership'] == 4) { echo 'selected="selected"'; } ?> value="4" >Other Building</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbi_ownership" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbi_ownership'] == 5) { echo 'selected="selected"'; } ?> value="5" >No Building</input>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_shift" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_shift'] == 1) { echo 'selected="selected"'; } ?> value="1" >Morning</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_shift" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_shift'] == 2) { echo 'selected="selected"'; } ?> value="2" >Afternoon</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_shift" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_shift'] == 3) { echo 'selected="selected"'; } ?> value="3" >Both Shifts</input><br>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_level" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_level'] == 1) { echo 'selected="selected"'; } ?> value="1" >Primary</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_level" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_level'] == 2) { echo 'selected="selected"'; } ?> value="2" >Middle</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_level" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_level'] == 3) { echo 'selected="selected"'; } ?> value="3" >Elementary</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_level" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_level'] == 4) { echo 'selected="selected"'; } ?> value="4" >Secondary</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_level" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_level'] == 5) { echo 'selected="selected"'; } ?> value="5" >Higher Secondary</input><br>
				</td>
				<td>
					<input class="merged_<?php echo ($x+1); ?>_dsi_sch_medium" type="radio" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_medium'] == 1) { echo 'selected="selected"'; } ?> name="merged_<?php echo ($x+1); ?>_dsi_sch_medium" value="1" >Urdu Medium</input>
					<input class="merged_<?php echo ($x+1); ?>_dsi_sch_medium" type="radio" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_medium'] == 2) { echo 'selected="selected"'; } ?> name="merged_<?php echo ($x+1); ?>_dsi_sch_medium" value="2" >Sindhi Medium</input>
					<input class="merged_<?php echo ($x+1); ?>_dsi_sch_medium" type="radio" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_medium'] == 3) { echo 'selected="selected"'; } ?> name="merged_<?php echo ($x+1); ?>_dsi_sch_medium" value="3" >English Medium</input>
					<input class="merged_<?php echo ($x+1); ?>_dsi_sch_medium" type="radio" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_medium'] == 4) { echo 'selected="selected"'; } ?> name="merged_<?php echo ($x+1); ?>_dsi_sch_medium" value="4" >Mixed Medium</input>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_sch_gender" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_gender'] == 1) { echo 'selected="selected"'; } ?> value="1" >Boys</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_sch_gender" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_gender'] == 2) { echo 'selected="selected"'; } ?> value="2" >Girls</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_dsi_sch_gender" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_sch_gender'] == 3) { echo 'selected="selected"'; } ?> value="3" >Mixed School</input><br>
				</td>
				<td>
					<input type="text" name="merged_<?php echo ($x+1); ?>_dsi_old_cost_center" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['dsi_old_cost_center']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_male" type="number" name="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_male" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_govt_teacher_number_male']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_female" type="number" name="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_female" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_govt_teacher_number_female']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_non_teacher_number_male" type="number" name="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_male" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_govt_teacher_number_male']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_non_teacher_number_female" type="number" name="merged_<?php echo ($x+1); ?>_sti_govt_teacher_number_male" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_govt_teacher_number_male']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_enrollment_boys" type="number" name="merged_<?php echo ($x+1); ?>_sti_enrollment_boys" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_enrollment_boys']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_sti_enrollment_girls" type="number" name="merged_<?php echo ($x+1); ?>_sti_enrollment_girls" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['sti_enrollment_girls']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_total_rooms" type="number" name="merged_<?php echo ($x+1); ?>_total_rooms" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['total_rooms']; ?>" ></input>
				</td>
				<td>
					<input class="teachers_number nonnegative number maxthree" id="merged_<?php echo ($x+1); ?>_total_classrooms" type="number" name="merged_<?php echo ($x+1); ?>_total_classrooms" value="<?php echo $merged_schools_array[$x]['SemisConsolidationUniv201415']['total_classrooms']; ?>" ></input>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_condition_bwall" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_condition_bwall'] == 1) { echo 'selected="selected"'; } ?> value="1" >Satisfactory</input>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_condition_bwall" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_condition_bwall'] == 2) { echo 'selected="selected"'; } ?> value="2" >Needs Repair</input>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_condition_bwall" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_condition_bwall'] == 3) { echo 'selected="selected"'; } ?> value="3" >Dangerous</input>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_condition_bwall" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_condition_bwall'] == 4) { echo 'selected="selected"'; } ?> value="4" >No Boundary Wall</input>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_washrooms" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_washrooms'] == 1) { echo 'selected="selected"'; } ?> value="1" >Yes</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_washrooms" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_washrooms'] == 2) { echo 'selected="selected"'; } ?> value="2" >No</input><br>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_drinking_water" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_drinking_water'] == 1) { echo 'selected="selected"'; } ?> value="1" >Yes</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_drinking_water" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_drinking_water'] == 2) { echo 'selected="selected"'; } ?> value="2" >No</input><br>
				</td>
				<td>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_electricity" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_electricity'] == 1) { echo 'selected="selected"'; } ?> value="1" >Yes</input><br>
					<input type="radio" name="merged_<?php echo ($x+1); ?>_sbf_electricity" <?php if($merged_schools_array[$x]['SemisConsolidationUniv201415']['sbf_electricity'] == 2) { echo 'selected="selected"'; } ?> value="2" >No</input><br>
				</td>
				</tr>
				<?php
				}
