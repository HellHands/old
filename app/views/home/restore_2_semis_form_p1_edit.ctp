...
<div id="table_first">
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator" id="" onload="init();" >
<tr><td><label>Coordinates Longitude</label></td><td><input readonly="readonly" type="text" placeholder="22-22.2222" name="coord_long" value="<?php echo $schools['SemisUniversal201415']['coord_long'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td><label>Coordinates Longitde</label></td><td><input readonly="readonly" type="text" placeholder="22-22.2222" name="coord_lat" value="<?php echo $schools['SemisUniversal201415']['coord_lat'] ?>" pattern="\d{2}-?\d{2}.?\d{4}" ></input></td></tr>
<tr><td colspan=2 >
					<h6><b>Q1. School Basic Information</b></h6>
</td></tr>
<tr><td><label>District</label></td><td>
...
<table border="0" cellpadding="0" cellspacing="0" class="CSSTableGenerator" >	
<!-- tr><td><label>Old SEMIS Code</label></td><td><input class="semis_code" readonly="readonly" type="number" id="school_semis_old" name="school_semis_old" value="" ></input></td></tr-->
<tr><td><label>(c). Tappa</label></td><td><input type="text" <?php if(!empty($schools['SemisUniversal201415']['bi_school_tappa'])) { ?> readonly="readonly" <?php } ?> name="bi_school_tappa" value="<?php echo $schools['SemisUniversal201415']['bi_school_tappa']; ?>" ></input></td></tr>
<tr><td><label>(d). Deh</label></td><td><input <?php if(!empty($schools['SemisUniversal201415']['bi_school_deh'])) { ?> readonly="readonly" <?php } ?> type="text" name="bi_school_deh" value="" ></input></td></tr>
...
<tr>
	...
	<td><input type="number" class="nonnegative number maxthree" name="sfaci_electric_fan