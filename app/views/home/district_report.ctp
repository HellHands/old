<script>
$(function() {
$('#district_report_form').validate();
});
</script>

<br />
<form id="district_report_form" action="<?php echo $this->webroot?>home/submit_district_report_details" method="post">
<h1 class="main-heading">Identifiers for Report Based On Baseline Survey for District</h1>
...
<div style="height:20px;"><input type="checkbox" name="school_oppurtunities" >Educational Oppurtunities in periphery of clusters</input></div>
