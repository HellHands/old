...
<tr><td><label>Q7.(i) School Name</label></td><td><input type="text" name="bi_school_name" value="<?php echo $schools[0]['Univ2012']['Prefix'].' - '.$schools[0]['Univ2012']['SchoolName']; ?>" ></input></td>
<td><label>Q7.(ii) School Address</label></td><td><input type="text" name="bi_school_address" value="<?php echo $schools[0]['Univ2012']['SchoolAddress']; ?>" ></input></td></tr>
<tr><td><label>Q7.(iii) School Village / Mohalla</label></td><td><input type="text" name="bi_school_village_mohallah" value="<?php echo $schools[0]['Univ2012']['Village-Mohalla']; ?>" ></input></td>
<td><label>Q7.(iv) Phone Number</label></td><td><input type="text" name="bi_school_phone_number" value="<?php echo $schools[0]['Univ2012']['Phone']; ?>" ></input></td></tr>
...
<label>c. Head Teacher Designation</label></td>
<td colspan="3">
			<input type="radio" name="hti_designation" value="1" >Head Master</input>
			<input type="radio" name="hti_designation" value="2" >Incharge</input>
			<input type="radio" name="hti_designation" value="3" >Teacher</input>
			<input type="radio" name="hti_designation" value="4" >Other (Specify)</input>
			<script>
				$('input[name=hti_designation]').on('keyup keypress blur change', function() {
					var hti_designation = $('input[name=hti_designation]:checked').val();
					if(hti_designation == '4')
...
<tr style="color:#007B47;font-size:13px;font-weight:bold;background:none !important;"><td colspan="2" >Q9. Detailed School Information</td></tr>
<tr><td><label>a. Status</label></td>
<td colspan="3">
...
<td>			<input type="radio" name="dsi_sch_gender" value="1" >Boys</input><br>
			...
			<input type="radio" name="dsi_sch_gender" value="3" >Mixed School / Co-Education</input><br></td>
<td><label>Q15. Medium [Multiple Ticks Allowed] and Medium Wise Enrollment as on reference date 31/10/2013</label></td>
<td>			
...
<tr class="urdumediumenrollment_display" style="display:none;" ><td><label>Urdu Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_urdu" name="dsi_enrollment_urdu" value="" ></input></td>
<td class="sindhimediumenrollment_display"><label>Sindhi Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_sindhi" name="dsi_enrollment_sindhi" value="" ></input><br></td></tr>
<tr class="englishmediumenrollment_display" style="display:none;" ><td><label>English Medium Enrollment</label></td><td><input type="text" class="dsi_enrollment_english" name="dsi_enrollment_english" value="" ></input><br></td>

<td><label>Q16. Shift</label></td>
<td>
			<input type="radio" name="dsi_shift" value="1" >Morning</input><br>
			<input type="radio" name="dsi_shift" value="2" >Afternoon / Evening</input><br>
...
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>Q19. (d) (ii) Construction Type of Building</label></td>
			<td>
...
<tr style="display:none;" class="sbi_schoolbuildingdisplay" ><td><label>Q19. (d) (iv) Total Number of Rooms (All Rooms)</label></td><td><input type="number" class="nonnegative number maxthree" id="sbi_school_building_total_rooms" name="sbi_school_building_total_rooms" value="" ></input></td></tr>
...
<tr>
	<td colspan=2 >
		<h6><b>Q20. Basic Facilities</b></h6>
	</td>
</tr>
...
<tr><td><label>Q20. (b) Are the Toilets Available</label></td>
			<td>
...
<tr style="display:none;" class="sbf_schooltoiletsdisplay" ><td><label>Q20. (b) If Toilets Available Write Number non functional</label></td>
			<td>
...
<tr><td colspan=2 >
					<h6><b>Q21. (a) Total Number of Working Teachers </b></h6>
</td></tr>

<tr><td><label>Q21. (a) (i)  Government Male Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_govt_teacher_number_male" type="number" name="sti_govt_teacher_number_male" value="" ></input></td></tr>
<tr><td><label>Q21. (a) (ii)  Non Government Male Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_non_govt_teacher_number_male" type="number" name="sti_non_govt_teacher_number_male" value="" ></input></td></tr>
<tr><td><label>Q21. (a) (iii)  Government Female Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_govt_teacher_number_female" type="number" name="sti_govt_teacher_number_female" value="" ></input></td></tr>
<tr><td><label>Q21. (a) (iv)  Non Government Female Teachers</label></td><td><input class="teachers_number nonnegative number maxthree" id="sti_non_govt_teacher_number_female" type="number" name="sti_non_govt_teacher_number_female" value="" ></input></td></tr>
<tr><td><label>Q21. (a) (v) Total Teachers</label></td><td><input class="total_teachers" type="number" readonly="readonly" name="sti_teacher_mf_total" value="" ></input></td></tr>

<tr><td colspan=2 >
					<h6><b>Q21. (b) Total Number of Non Teaching Staff </b></h6>
</td></tr>
<tr><td><label>Q21. (b) (i)  Non Teaching Staff Male</label></td><td><input type="number" class="non_teacher_number nonnegative number maxthree" id="sti_govt_non_teaching_number_male" name="sti_govt_non_teaching_number_male" value="" ></input></td></tr>
<tr><td><label>Q21. (b) (ii)  Non Teaching Staff Female</label></td><td><input type="number" class="non_teacher_number nonnegative number maxthree" id="sti_govt_non_teaching_number_female" name="sti_govt_non_teaching_number_female" value="" ></input></td></tr>
<tr><td><label>Q21. (b) (iii) Total Non Teaching Staff</label></td><td><input class="total_non_teachers" readonly="readonly" type="number" name="sti_govt_non_teaching_mf_total" value="" ></input></td></tr>

<tr><td><label>Signature of Head of the School Head Teacher / DDO Secondary and Higher Secondary School</label></td><td>
