...
<script type="text/javascript">
		$(function() 
		{
			...
			$.ajax({
						url: '<?php echo $this->webroot?>home/teachers_retiring/report/0/'+designation+'/'+qualification+'/'+location,
						type: "GET",
						cache: false,
...
<table border="0" cellpadding="0" cellspacing="0" class="grid_table wf" id="district" >
	<tr>
		<td>Retiring From</td>
		<td>
			<input type="text" name="retiring_from" value="" class="datetime" />
		</td>
	</tr>
	<tr>
		<td>Retiring To</td>
		<td>
			<input type="text" name="retiring_to" value="" class="datetime" />
		</td>
	</tr>
	<tr>
		<td>Designation</td>
